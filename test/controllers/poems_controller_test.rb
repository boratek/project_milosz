...
class PoemsControllerTest < ActionController::TestCase
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post :create, poem: { incipit: @poem.incipit, meter: @poem.meter, poem: @poem.poem, title: @poem.title, volume: @poem.volume, year: @poem.year }
    end
  ...
  test "should update poem" do
    patch :update, id: @poem, poem: { incipit: @poem.incipit, meter: @poem.meter, poem: @poem.poem, title: @poem.title, volume: @poem.volume, year: @poem.year }
    assert_redirected_to poem_path(assigns(:poem))
  end
